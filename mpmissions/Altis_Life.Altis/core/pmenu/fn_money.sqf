...
_atmstatus ctrlSetStructuredText parseText format [" $%1",[life_atmbank] call life_fnc_numberText];
_cashstatus ctrlSetStructuredText parseText format [" $%1",[TTP_cash] call life_fnc_numberText];
