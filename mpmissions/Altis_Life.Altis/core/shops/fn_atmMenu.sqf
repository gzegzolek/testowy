...
lbClear _units;
CONTROL(2700,2701) ctrlSetStructuredText parseText format["<t size='2px'>$ %2</t><br/><t size='2px'>$ %1</t>",[TTPBANK] call life_fnc_numberText,[CASH] call life_fnc_numberText];
